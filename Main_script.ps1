...
ssh $username@$server "wget https://raw.githubusercontent.com/RJSkudra/Fam-Biz_pi/main/docker-install.sh;bash -l && chmod +x docker-install.sh && ./docker-install.sh"
